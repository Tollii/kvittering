...
Recommended order: correct discount/category handling and review labels; simplify receipt review; reorder spending; then evaluate offline history. Select the next scope before writing implementation plans.
