export const categoryGroups = [
	...
	['desserts', 'Desserter', 'puddings:Pudding|dessert-yoghurt:Dessertyoghurt|cakes:Kaker'],
	[
		'household',
		'Husholdning',
	...
	['fallback', 'Uavklart', 'food:Annen mat|non-food:Andre varer|unclear:Ukjent vare']
] as const;
export const categories = categoryGroups.flatMap(([group, groupName, entries]) =>
