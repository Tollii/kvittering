...
export function compatibleProduct(
	...
	if (left.brand && right.brand && matchingKey(left.brand) !== matchingKey(right.brand))
		return false;
...
export function similarProducts<T extends ProductEvidence>(line: ProductEvidence, products: T[]) {
